...
var LimitOrderProvider = class {
  ...
  getFee() {
    return __async(this, null, function* () {
      let [feeAuthority] = _web3js.PublicKey.findProgramAddressSync(
        [Buffer.from("fee")],
        this.program.programId
      );
      return yield this.program.account.fee.fetch(feeAuthority);
    });
  }
  getOrder(pubkey) {
    return __async(this, null, function* () {
...
exports.IDL = IDL; exports.LIMIT_ORDER_REFERRAL = LIMIT_ORDER_REFERRAL; exports.LimitOrderProvider = LimitOrderProvider; exports.PROGRAM_ID_BY_CLUSTER = PROGRAM_ID_BY_CLUSTER; exports.inputMintFilter = inputMintFilter; exports.outputMintFilter = outputMintFilter; exports.ownerFilter = ownerFilter;
