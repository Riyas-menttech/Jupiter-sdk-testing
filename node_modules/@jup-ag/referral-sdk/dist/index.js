    ...
    return __async(this, arguments, function* ({
      ...
      const vtTxs = yield Promise.all(
        [tokenAccounts, token2022Accounts].map((accounts, idx) => __async(this, null, function* () {
          ...
          const claimParams = yield Promise.all(
            tokensWithAmount.map((token) => __async(this, null, function* () {
              ...
              if (!partnerTokenAccount) {
                partnerTokenAccount = _spltoken.getAssociatedTokenAddressSync.call(void 0, 
                  token.account.mint,
                  referralAccount.partner,
                  true,
                  tokenProgramId
              ...
              if (!projectAdminTokenAccount) {
                projectAdminTokenAccount = _spltoken.getAssociatedTokenAddressSync.call(void 0, 
                  token.account.mint,
                  project.admin,
                  true,
                  tokenProgramId
          ...
          const batchParams = _chunk2.default.call(void 0, claimParams, 5);
          return Promise.all(
...
exports.IDL = IDL; exports.PROGRAM_ID = PROGRAM_ID; exports.ReferralProvider = ReferralProvider; exports.projectAdminFilter = projectAdminFilter; exports.referralAccountPartnerFilter = referralAccountPartnerFilter; exports.referralAccountProjectFilter = referralAccountProjectFilter; exports.useReferral = useReferral;
